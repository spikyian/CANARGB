...
static DiagnosticVal nvDiagnostics[2 +1];
# 82 "../../VLCBlib_PIC/nv.c"
...
int16_t getNV(uint8_t index) {
    ...
    if (index > 48) return -CMDERR_INV_NV_IDX;
